(function (window) {
    ...
    function init(game) {
        ...
        createCannon("top", 635, 250);
        createCannon("top", 65, 7500);
        createCannon("top", 605, 250);
        createCannon("top", 665, 250);
        createCannon("bottom", 635, 250);
        createCannon("bottom", 605, 250);
        createCannon("bottom", 665, 250);
